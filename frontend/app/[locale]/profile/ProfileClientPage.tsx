...
export default function ProfilePage() {
    ...
    return (
      <div className="min-h-screen bg-blue-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
          <h1 className="text-xl font-bold text-red-600 mb-4">{t('errorTitle')}</h1>
  ...
  if (!profile) {
    return (
      <div className="min-h-screen bg-blue-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-lg p-6 max-w-md w-full">
          <h1 className="text-xl font-bold text-gray-800 mb-4">{t('noProfileTitle')}</h1>
          <p className="mb-6">{t('noProfileMessage')}</p>
          <Button
            href="/auth/login"
            variant="default"
          >
      ...
      <div className="container mx-auto max-w-2xl space-y-8">
        ...
        <section className="bg-white rounded-xl shadow-lg p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
            <UserIcon className="w-6 h-6 text-indigo-500" /> {t('myInfo.title')}
          </h2>
          {/* 프로필 이미지 */}
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            {isEditing ? (
              <input
                ...
                placeholder={t('myInfo.nicknamePlaceholder')}
              />
            ) : (
          ...
          <div className="flex items-center gap-3 mb-4 opacity-60">
            ...
            <input type="tel" className="w-full px-4 py-2 border border-gray-200 rounded-lg bg-gray-50" placeholder={t('myInfo.phonePlaceholder')} value={phone} onChange={e => setPhone(e.target.value)} disabled />
            <span className="ml-2 text-xs text-gray-400 bg-gray-100 rounded px-2 py-0.5">{t('placeholders.comingSoon')}</span>
          </div>
        ...
        <section className="bg-white rounded-xl shadow-lg p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
            <CreditCardIcon className="w-6 h-6 text-indigo-500" /> {t('subscriptionInfo.title')}
          </h2>
          {/* 플랜/남은 기간/업그레이드 */}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-semibold text-blue-800">
                  {profile.trialEndsAt ? t('subscriptionInfo.trial') : t('subscriptionInfo.premium')}
                </span>
                <span className="ml-2 text-xs text-gray-500">(
                  남은 기간: {profile.trialEndsAt ? t('subscriptionInfo.remainingTime', {time:formatDate(profile.trialEndsAt)}) : t('subscriptionInfo.premiumActivation')}
                )</span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3 mb-4 opacity-60">
            ...
            <button className="bg-red-100 text-red-700 px-3 py-1 rounded text-sm cursor-not-allowed" disabled>{t('subscriptionInfo.unsubscribe')}</button>
            <span className="ml-2 text-xs text-gray-400 bg-gray-100 rounded px-2 py-0.5">{t('placeholders.comingSoon')}</span>
          </div>
          ...
          <div className="flex items-center gap-3 mb-4 opacity-60">
            ...
            <button className="bg-indigo-200 text-indigo-700 rounded px-3 py-1 cursor-not-allowed" disabled>{t('subscriptionInfo.apply')}</button>
            <span className="ml-2 text-xs text-gray-400 bg-gray-100 rounded px-2 py-0.5">{t('placeholders.comingSoon')}</span>
          </div>
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <a href="/help" className="text-indigo-600 text-sm hover:underline">{t('subscriptionInfo.faq')}</a>
          </div>
        </section>
        ...
        <section className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="flex items-center gap-3 mb-4 opacity-60">
            ...
            <span className="text-gray-700">{t('myInfo.emailNotification')}</span>
            <input type="checkbox" className="accent-indigo-500" disabled />
            <span className="text-xs text-gray-400 bg-gray-100 rounded px-2 py-0.5 ml-2">{t('placeholders.comingSoon')}</span>
          </div>

          {/* 테마 설정 (UI만) */}
          <div className="flex items-center gap-3 mb-4 opacity-60">
            <MoonIcon className="w-5 h-5 text-indigo-400" />
            <span className="text-gray-700">{t('myInfo.darkMode')}</span>
            <input type="checkbox" className="accent-indigo-500" disabled />
            <span className="text-xs text-gray-400 bg-gray-100 rounded px-2 py-0.5 ml-2">{t('placeholders.comingSoon')}</span>
          </div>
          ...
          <div className="flex items-center gap-3 mb-4 opacity-60">
            ...
            <button className="bg-gray-100 text-gray-700 px-3 py-1 rounded text-sm cursor-not-allowed" disabled>{t('myInfo.downloadData')}</button>
            <span className="text-xs text-gray-400 bg-gray-100 rounded px-2 py-0.5 ml-2">{t('placeholders.comingSoon')}</span>
          </div>
          <div className="flex items-center gap-3 mb-4 opacity-60">
            <ShieldCheckIcon className="w-5 h-5 text-indigo-400" />
            <button className="bg-gray-100 text-gray-700 px-3 py-1 rounded text-sm cursor-not-allowed" disabled>{t('myInfo.privacyPolicy')}</button>
            <span className="text-xs text-gray-400 bg-gray-100 rounded px-2 py-0.5 ml-2">{t('placeholders.comingSoon')}</span>
          </div>
          ...
          <div className="flex items-center gap-3 mb-4 opacity-60">
            <XCircleIcon className="w-5 h-5 text-red-300" />
            <button className="bg-red-100 text-red-700 px-3 py-1 rounded text-sm cursor-not-allowed" disabled>{t('myInfo.deleteAccount')}</button>
            <span className="text-xs text-gray-400 bg-gray-100 rounded px-2 py-0.5 ml-2">{t('placeholders.comingSoon')}</span>
          </div>
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <Button variant="danger" className="w-full" onClick={logout}>{t('myInfo.logout')}</Button>
          </div>

          {/* 고객센터/피드백 */}
          <div className="flex items-center gap-3 mt-4">
            <LifebuoyIcon className="w-5 h-5 text-indigo-400" />
            <a href="/help" className="text-indigo-600 text-sm hover:underline">{t('myInfo.customerSupport')}</a>
          </div>
        </section>
      </div>
    </div>
