...
export default function UpgradePage() {
  ...
  const pricingPlans: PricingPlan[] = [
    ...
    },
    {
      ...
      intervalUnit: '월',
      description: '정책 기준 유료 혜택 제공: 인지분석 결과보기 포함, 무료 한도 초과 시 계속 이용.',
      features: [
        '인지분석 결과보기 이용 가능(유료 전용)',
        'AI 하이브리드 검색+대화: 무료 한도 초과 시 계속 이용',
        'PDF 하이라이트/메모: 무료 한도 초과 시 계속 이용',
        'AI-Link 생성: 무료 한도 초과 시 계속 이용',
        'TS 메모카드: 101개 이상 작성 가능',
      ],
    ...
    },
    {
      ...
      intervalUnit: '월',
      description: 'Pro 혜택 포함. 인지분석 결과보기 포함, 무료 한도 초과 시 계속 이용.',
      features: [
        '인지분석 결과보기 이용 가능(유료 전용)',
        'AI 하이브리드 검색+대화: 무료 한도 초과 시 계속 이용',
        'PDF 하이라이트/메모: 무료 한도 초과 시 계속 이용',
