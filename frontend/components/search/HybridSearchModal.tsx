  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
        ...
        <div className="flex flex-col max-h-[90vh]">
          ...
          {/* 검색 입력 영역 */}
          <div className="flex flex-col sm:flex-row gap-2 my-4 sticky top-0 z-10 bg-secondary/95 backdrop-blur supports-[backdrop-filter]:bg-secondary/75 pt-4 sm:static sm:bg-transparent sm:backdrop-blur-0 sm:supports-[backdrop-filter]:bg-transparent">
