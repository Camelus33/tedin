...
const faqData = [
  {
    question: "3분으로 정말 독서가 가능한가요?",
    answer: "네, 가능합니다! 3분은 '시작'을 위한 시간입니다. 처음엔 반신반의하셨던 분들도 '아, 이 정도면 할 수 있겠다'는 경험을 하게 됩니다. 중요한 건 속도가 아니라 '매일 페이지를 넘기는 경험'입니다. 3분씩 33번이면 어느새 책 한 권을 완독하게 되죠."
  },
  {
