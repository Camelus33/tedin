...
const steps: AMFAStep[] = [
  {
    id: 'atomic',
    title: '한 줄의 힘',
    subtitle: '몰입에서 태어난 아이디어',
    description: '깊게 집중한 순간 떠오른 한 줄이 모든 것을 바꿉니다. 작지만 강력한 이 아이디어가 성장의 시작입니다.',
    icon: BookOpen,
  ...
  },
  {
    ...
    title: '생각 연결하기',
    subtitle: '아이디어가 만나다',
    description: '한 줄 아이디어에 새로운 생각을 더하고 다른 지식과 연결합니다. 혼자였던 아이디어가 친구들을 만나 더 강해집니다.',
    icon: Lightbulb,
  ...
  },
  {
    ...
    title: '완성된 이야기',
    subtitle: '하나로 이어진 지식',
    description: '연결된 생각들을 하나의 완성된 이야기로 만듭니다. 이제 누구나 쉽게 이해할 수 있는 명확한 지식이 됩니다.',
    icon: Flame,
  ...
  },
  {
    ...
    title: 'AI-Link 완성',
    subtitle: '남다른 답변의 비밀',
    description: '완성된 이야기를 AI가 바로 사용할 수 있는 형태로 만듭니다. 이제 AI가 당신만의 지식으로 특별한 답변을 만들어냅니다.',
    icon: Cpu,
