...
interface HabitusMascotProps {
  size?: 'sm' | 'md' | 'lg' | 'xl';
  animate?: boolean;
  className?: string;
}

export function HabitusMascot({ 
  size = 'lg', 
  animate = true, 
  className = '' 
}: HabitusMascotProps) {
        ...
        <div className="relative z-10 w-full h-full flex items-center justify-center">
          ...
          >
            ...
            <g fill="#e0ac7e">
              ...
              <path d="M60.8 38.9c-.7 1.2-1.1 2.3-1.2 3.2.1.8.6 1.7 1.2 2.6.7-1.2 1.1-2.3 1.2-3.2-.1-.8-.6-1.7-1.2-2.6M58.9 35.9c.5 5.8-12 7.9-21.5 7.9-12.3 0-20.8-20.5-18.3-17 3.4 4.7 5.8-2.3 8.5-3.2 5.9-2 10.9.1 17.1.7 7.8.7 14.2 5.2 14.2 11.6"/>
              <path d="M55 28.1c0 5.3-3.2 7.7-7.1 7.7s-7.1-4.3-7.1-9.7c0-.3 3.2-9.7 7.1-9.7 3.9.1 7.1 10.4 7.1 11.7"/>
              <path d="M41.9 24.5c0 5.3-3.2 9.7-7.1 9.7-3.9 0-7.1-4.3-7.1-9.7 0-.3 3.2-9.7 7.1-9.7s7.1 9.4 7.1 9.7"/>
...
// CSS 애니메이션을 위한 스타일 (Tailwind에서 커스텀 애니메이션)
export const habitusAnimationStyles = `
